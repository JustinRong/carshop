        ...
        <script language="javascript">
           function check()
           {
               ...
               if(document.formAdd.jiage.value=="")
               {
                ...
                var jiage=document.formAdd.jiage.value; 
			...
			{
				var strUrl = "<%=path %>/yuangong?type=yuangongAll";
				var ret = window.showModalDialog(strUrl,"","dialogWidth:950px; dialogHeight:500px; dialogLeft: status:no; directories:yes;scrollbars:yes;Resizable=no;");
			    if(ret==undefined)
			    {
			        ret="";
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form action="<%=path %>/xiaoshou?type=xiaoshouAdd" name="formAdd" method="post">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/img/wbg.gif" class='title'><span>销售管理</span></td>
					    </tr>
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="jiage" size="20"/>(万，小数点后最多2位)
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="15%" bgcolor="#FFFFFF" align="right">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    ...
						    <td width="85%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="yuangong_id" id="yuangong__id" size="20" readonly="readonly"/>
						        <input type="button" value="选择" onclick="yuangongAll()"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="15%" bgcolor="#FFFFFF" align="right">
