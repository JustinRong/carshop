...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            ...
            {
            	debugger;
                 var userPwReal="${sessionScope.adminPw}";
                 ...
                 var newPwd = document.formPw.userPw1.value;
                 var manaId = "${sessionScope.manaId}";
                 document.getElementById("indicator").style.display="block";
                 $.ajax({
                	 url:'<%=path %>/manager/updatePwd.action',
                	 type:"post",
                	 data:{"newPwd":newPwd,"manaId":manaId},
                	 dataType:"json",
			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" value="${sessionScope.adminuserName }" name="userName" size="20" disabled="disabled"/>
				    </td>
				</tr>
				<tr bgcolor="#FFFFFF">
				    <td width="25%" bgcolor="#FFFFFF" align="right">
